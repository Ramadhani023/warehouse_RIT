                ...
                <ul class="lg:flex lg:flex-row md:p-0 rounded-lg bg-transparent md:space-x-8 md:grid  md:border-0">
                    ...
                    <li>
                        <a href="{{ route('warehouse.main') }}"
                            class="block py-2 px-3 text-white rounded hover:text-slate-300 md:p-4">WAREHOUSE</a>
                    </li>
                    <li>
                    ...
                    @if (Route::is('profile.main'))
                        <li>
                            <form method="POST" action="{{ route('logout') }}" class="">
                                @csrf
                                <button type="submit"
                                    class="block py-2 px-3 text-black font-semibold bg-slate-300  rounded hover:text-red-600 md:p-4">
                                    Logout
                                </button>
                            </form>
